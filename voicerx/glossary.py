...
CLINICAL_TERMS: dict[str, tuple[str, ...]] = {
    ...
    "breathlessness": ("শ্বাসকষ্ট", "দম বন্ধ", "হাঁপ ধরা", "হাফ ধরে",
                        ...
                        "দম আটকে আসছে", "বুক হাঁপিয়ে উঠছে"), #
    ...
    "thyroid": ("থাইরয়েড",), #
    # general symptoms
    "fever": ("জ্বর", "জ্বর জ্বর ভাব", "গা গরম", "গা গরম হয়ে আছে",
               "গা পুড়ে যাচ্ছে"), #
    "cough": ("কাশি", "খুসখুসে কাশি", "শুকনো কাশি", "কাশির দমক",
               "কাশতে কাশতে দম বন্ধ"), #
    ...
    "loose stools": ("পাতলা পায়খানা", "ডায়রিয়া", "পায়খানা", "diarrhea",
                      "পেট খারাপ", "পেট নামছে", "পায়খানা পাতলা হচ্ছে"), #
    "constipation": ("কোষ্ঠকাঠিন্য", "পায়খানা শক্ত", "constipation",
                      "পেট পরিষ্কার হচ্ছে না", "পায়খানা হচ্ছে না"),
    "acidity": ("অম্বল", "গ্যাস", "গ্যাস হয়েছে", "গ্যাস হয়ে গেছে",
                 "চোয়া ঢেকুর", "টক ঢেকুর", "বুক জ্বালা করছে",
                 "টক জল উঠছে", "acidity"),
    ...
    "vomiting": ("বমি",), #
    "nausea": ("গা গোলানো", "বমি ভাব", "গা বমি বমি করছে", "বমি পাচ্ছে",
                "গা গুলিয়ে উঠছে"), #
    ...
    "weakness": ("দুর্বলতা", "দুর্বল", "শরীর দিচ্ছে না", "জোর পাচ্ছি না",
                  "গা ম্যাজম্যাজ করছে"), #
    ...
    "throbbing pain": ("টনটন করছে", "দপদপ করছে", "কনকন করছে",
                        "মাথা দপদপ করছে"),
    "sharp pain": ("চিলিক মারছে", "চিলিক দিয়ে উঠছে",
                    "সুঁচ ফোটার মতো ব্যথা", "খামচে ধরছে"),
    "burning sensation": ("জ্বালাপোড়া করছে", "জ্বালা করছে",
                           "ছ্যাঁকা লাগার মতো"),
    "blurred vision": ("ঝাপসা দেখা", "ঘোলাটে দৃষ্টি"), #
    "dizziness": ("মাথা ঘোরা", "মাথা ঘুরছে", "মাথা ঝিমঝিম করছে",
                   "মাথা টলছে", "চোখে অন্ধকার দেখছি"), #
    ...
    "numbness": ("অবশ", "ঝিনঝিন", "অসাড়", "হাত পা ঝিঁঝিঁ ধরছে",
                  "সাড় পাচ্ছি না"), #
